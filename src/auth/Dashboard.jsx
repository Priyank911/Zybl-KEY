...
const Dashboard = () => {
  ...
  useEffect(() => {
    ...
    const checkAuth = async () => {
      ...
      try {
        ...
        const userId = urlUserId || parsedData.userID;
        ...
        try {
          await trackUserJourney(userId, 'dashboard', {
  ...
  const saveSettings = async () => {
    ...
    try {
      const success = await updateUserSettings(dashboardData.userData.userID, settings);
              ...
              <div className="dashboard-column main-column">
                ...
                {/* DID Credential Card */}                <div className="dashboard-card modern-card did-credential-container">
                  ...
                  <div className="card-content">
                    {didDocument ? (
                      <DIDCredentialCard didDocument={didDocument} size="large" showActions={true} />
                    ) : (
              ...
              <div className="card-content verification-tab">
                <div className="verification-tab-content">
                  ...
                  <div className="verification-status-detail">
                    <div className="verification-score-circle" style={{ '--score': `${verificationScore}%` }}>
                      <div className="score-value">{verificationScore}%</div>
                      <div className="score-label">Sybil<br/>Score</div>
                    </div>
                    ...
                    <div className="verification-details-list">
                      ...
                      <div className="verification-detail-item">
                        ...
                        <div className="detail-value">
                          <button className="verification-action-button">
