...
const About = () => {
  return (
    <section id="about" className="about-section">
      <div className="about-container">        <div className="about-header">
        ...
        <div className="about-content">
            ...
            <div className="about-card">
              <div className="card-icon">
                <svg width="32" height="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <path d="M23 20.9999V18.9999C22.9993 18.1136 22.7044 17.2527 22.1614 16.5522C21.6184 15.8517 20.8581 15.3515 20 15.1299" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
          ...
          <div className="about-partners">
            <h3 className="partners-title">Trusted by Leading Blockchain Projects</h3>
            <div className="partners-logos">
              <div className="partner-logo">
                <svg width="80" height="40" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <rect width="24" height="24" rx="4" fill="rgba(255,255,255,0.05)"/>
                  <path d="M12 6L18 12L12 18L6 12L12 6Z" stroke="white" strokeWidth="1.5"/>
                </svg>
                <span>Protocol A</span>
              </div>
              <div className="partner-logo">
                <svg width="80" height="40" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <rect width="24" height="24" rx="4" fill="rgba(255,255,255,0.05)"/>
              ...
              <div className="partner-logo">
                <svg width="80" height="40" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <rect width="24" height="24" rx="4" fill="rgba(255,255,255,0.05)"/>
                  <path d="M6 12H18M12 6V18" stroke="white" strokeWidth="1.5"/>
                </svg>
                <span>Network C</span>
              </div>
              <div className="partner-logo">
                <svg width="80" height="40" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <rect width="24" height="24" rx="4" fill="rgba(255,255,255,0.05)"/>
                  <path d="M12 18L18 12L12 6L6 12L12 18Z" stroke="white" strokeWidth="1.5"/>
                </svg>
                <span>Platform D</span>
              </div>
            </div>
          </div>
          ...
          <div className="about-quote">
            <blockquote>
              "The future of Web3 depends on creating secure, trustless systems that can verify real human participation while respecting individual privacy."
            </blockquote>
            <cite>- The Zybl Team</cite>
          </div>
        </div>
      </div>
    </section>
