 ...
 */
const DIDCredentialCard = ({ didDocument, size = 'normal', showActions = false }) => {
  ...
  return (
    <div className={`did-credential-card ${size}`}>
      ...
      <div className="did-info">
        ...
        <div className="info-item">
          <span className="info-label">SYBIL_SCORE</span>
          <span className="info-value score">{sybilScore}%</span>
        </div>
        <div className="info-item">
      ...
      {showActions && (
        <div className="did-actions">
          <button className="secondary-button">Copy ID</button>
