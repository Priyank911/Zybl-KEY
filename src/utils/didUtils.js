 ...
 */
export const formatDIDForDisplay = (didDocument) => {
  ...
  // Get Sybil score from attributes
  const sybilScore = didDocument.attributes.find(
    attr => attr.trait_type === "Sybil Score"
  )?.value || 0;
